...
* `th.consistent_condition_presence_percentage` percentage of gene cluster enyzmes that are expressed in each condition in order to annotate the condition to the cluster (default = 0.7, i.e. at least 70 % of all expressed gene cluster enzymes)
